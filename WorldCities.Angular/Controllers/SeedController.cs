...
namespace WorldCities.Angular.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        public SeedController(ApplicationDbContext context, RoleManager<IdentityRole> roleManager, 
        ...
        public async Task<ActionResult> CreateDefaultUsers()
        {
            ...
            //Sreate the default roles (if they doesn't exist yet)
            ...
            var email_Admin = "somady12@gmail.com";
            ...
            var email_User = "yessouf2009@yahoo.fr";
